...
export default class Geocoder {
  constructor(options) {
    ...
    // TODO will edit url API search geojson
    this.api = options && options.api || 'https://base-api.meeymap.com/api/poi/search/';
  }
  ...
  onAdd(map) {
    ...
    el.className = 'mapbox-ctrl-geocoder';
  ...
  _geocode(q, callback) {
    ...
    this.request.abort();
    //TODO will edit url search geocoder
